...
const i18nDict = {
    en: {
        ...
        "graph.back_to_global": "Back to Global Graph",
        "graph.filter_type": "Filter by Type:",
        "graph.filter_paper": "Filter by Paper:",
        "graph.all_papers": "All Papers",
        "graph.all_types": "All Types",
        "graph.node_count": "Nodes",
        "graph.edge_count": "Edges",
        "graph.search_placeholder": "Search graph nodes...",
        "graph.reset_zoom": "Reset View",
        "graph.relayout": "Re-layout",
        "graph.hide_orphans": "Connected Only",
        "graph.show_all_nodes": "All Notes",
        "graph.local_mode_hint": "Showing connected neighborhood of selected note.",
        "graph.no_data": "No notes available to display in graph.",
        "graph.tooltip.paper": "Paper",
        "graph.tooltip.type": "Type",
        "graph.tooltip.links": "Links",
        "graph.tooltip.tags": "Tags",
        "graph.tooltip.keywords": "Keywords",
        "nav.qa": "AI Assistant",
        "nav.theme": "Theme",
        "nav.lang": "Language",
    ...
    ja: {
        ...
        "nav.graph": "ナレッジグラフ",
        "graph.title": "ナレッジグラフ",
        "graph.back_to_global": "全体グラフに戻る",
        "graph.filter_type": "タイプで絞込:",
        "graph.filter_paper": "論文で絞込:",
        "graph.all_papers": "すべての論文",
        "graph.all_types": "すべてのタイプ",
        "graph.node_count": "ノード数",
        "graph.edge_count": "エッジ数",
        "graph.search_placeholder": "グラフ内ノードを検索...",
        "graph.reset_zoom": "視点をリセット",
        "graph.relayout": "再配置",
        "graph.hide_orphans": "リンクありのみ",
        "graph.show_all_nodes": "全ノート",
        "graph.local_mode_hint": "選択したノートの関連ネットワークを表示中",
        "graph.no_data": "グラフ表示できるノートがありません。",
        "graph.tooltip.paper": "論文",
        "graph.tooltip.type": "タイプ",
        "graph.tooltip.links": "関連リンク数",
        "graph.tooltip.tags": "タグ",
        "graph.tooltip.keywords": "キーワード",
        "nav.qa": "AIアシスタント",
        "nav.theme": "テーマ",
        "nav.lang": "言語",
